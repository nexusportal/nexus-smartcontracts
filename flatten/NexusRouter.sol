...
// File contracts/Libraries/SafeMathUniswap.sol
...
// File contracts/NexusSwap/Interfaces/INexusSwapPair.sol

// SPDX-License-Identifier-FLATTEN-SUPPRESS-WARNING: MIT
pragma solidity ^0.8.12;
interface INexusSwapPair is IUniswapV2Pair {}


// File contracts/Libraries/NexusSwapLibrary.sol
                ...
                uint256(
                    keccak256(
                        abi.encodePacked(
                            ...
                            hex"d2a827db204a04cdb069a19bc5e653ea3955565ae506c431add426b966a4736a" // init code hash
                        )
                    )
                )
            )
...
// File contracts/Mocks/IWETH.sol
...
// SPDX-License-Identifier-FLATTEN-SUPPRESS-WARNING: MIT
pragma solidity ^0.8.12;
interface INexusSwapFactory is IUniswapV2Factory {}
...
// File contracts/Uniswap/Interfaces/IERC20Uniswap.sol
